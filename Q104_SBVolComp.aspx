<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/AkzoCLM.Master" CodeFile="Q104_SBVolComp.aspx.cs" Inherits="Q104_SBVolComp" %>
    ...
    <asp:Panel ID="pnlMenuItem" runat="server" Style="text-align: left; height: 540px; width: 1100px; background-color: #f7e98e">
        <table>
            <tr>
                ...
                <td>
                    <asp:Label ID="Label2" runat="Server" Text="Q104 - Sub Brand Volume Comparison" ForeColor=" Black " Font-Names="Calibri" Font-Size="X-Large" Font-Bold="true"></asp:Label>
                </td>
                    ...
                    <table>
                        <tr>
                            <td style="Width:270px;">
                                ...
                                <br />
                                <asp:DropDownList ID="ddlFromYear" ToolTip="Which year's data you wish to check?" CssClass="ddl" runat="server" Width="220px"
                                    Font-Names="Calibri" Enabled="false">
                            ...
                            <td style="Width:270px;">
                                ...
                                <br />
                                <asp:DropDownList ID="ddlFromMonth" ToolTip="FY=Full Year,else select the month" CssClass="ddl" runat="server" Width="220px"
                                    Font-Names="Calibri" Enabled="false">
                            ...
                            <td style="Width:270px;">
                                ...
                                <br />
                                <asp:DropDownList ID="ddlToYear" ToolTip="Which year's data you wish to compare?" CssClass="ddl" runat="server"  Width="220px"
                                    Font-Names="Calibri" Enabled="false">
                                    <asp:ListItem Text="2021" Value="2021"></asp:ListItem>
                                    <asp:ListItem Text="2020" Value="2020"></asp:ListItem>
                                    <asp:ListItem Text="2019" Value="2019"></asp:ListItem>
                            ...
                            <td style="Width:270px;">
                                ...
                                <br />
                                <asp:DropDownList ID="ddlToMonth" ToolTip="FY=Full Year,else select the month" CssClass="ddl" runat="server" Width="220px"
                                    Font-Names="Calibri" Enabled="false">
                                    <asp:ListItem Text="FY" Value="FY"></asp:ListItem>
                                    <asp:ListItem Text="JAN" Value="JAN"></asp:ListItem>
                                    <asp:ListItem Text="FEB" Value="FEB"></asp:ListItem>
                        ...
                        <tr>
                            <td style="Width:270px;">
                                <asp:Label ID="Label36" runat="Server" Text="Sub Brand1" ForeColor=" Black " Font-Names="Calibri" Font-Size="Medium "></asp:Label>
                                <br />
                                <asp:DropDownList ID="ddlSubBrand1" ToolTip="Select the sub brand" CssClass="ddl" runat="server" Width="220px" Font-Names="Calibri">
                                </asp:DropDownList>
                            ...
                            <td style="Width:270px;">
                                ...
                                <br />
                                <asp:DropDownList ID="ddlFormula1" ToolTip="Select the formula" CssClass="ddl" runat="server" Width="220px"
                                    Font-Names="Calibri">
                            ...
                            <td style="Width:270px;">
                                <asp:Label ID="Label91" runat="Server" Text="SB1 Volume KLtrs" ForeColor=" Black " Font-Names="Calibri" Font-Size="Medium "></asp:Label>
                                <br />
                                <asp:TextBox ID="txtSB1Volume" runat="Server" Text="0" ToolTip="Enter sub brand volume in KLtrs" MaxLength="12" CssClass="ddl" Width="170px" ForeColor="Black" Font-Names="Verdana"></asp:TextBox>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td style="Width:270px;">
                                <asp:Label ID="Label41" runat="Server" Text="Sub Brand2" ForeColor=" Black " Font-Names="Calibri" Font-Size="Medium "></asp:Label>
                            <br />
                                <asp:DropDownList ID="ddlSubBrand2" ToolTip="Select the sub brand" CssClass="ddl" runat="server" Width="220px" Font-Names="Calibri">
                                </asp:DropDownList>
                            </td>
                           ...
                           <br />
                                <asp:DropDownList ID="ddlFormula2" ToolTip="Select the formula" CssClass="ddl" runat="server" Width="220px"
                                    Font-Names="Calibri">
                                    <asp:ListItem Text=">" Value="GT"></asp:ListItem>
                                    <asp:ListItem Text="<" Value="LT"></asp:ListItem>
                                    <asp:ListItem Text=">=" Value="GE"></asp:ListItem>
                            ...
                            <td style="Width:270px;">
                                <asp:Label ID="Label42" runat="Server" Text="SB2 Volume KLtrs" ForeColor=" Black " Font-Names="Calibri" Font-Size="Medium "></asp:Label>
                            <br />
                                <asp:TextBox ID="txtSB2Volume" runat="Server" Text="0" ToolTip="Enter sub brand volume in KLtrs" MaxLength="12" CssClass="ddl" Width="170px" ForeColor="Black" Font-Names="Verdana"></asp:TextBox>
                            </td>
                        </tr>
                        ...
                        <tr>
                           ...
                           <br />
                                <asp:DropDownList ID="ddlStatus" ToolTip="Default Status=Submitted" CssClass="ddl" runat="server" Font-Names="Calibri" Enabled="false" Width="220px">
                            ...
                            <br />
                                <asp:DropDownList ID="ddlSendTo" ToolTip="Email will be sent to the selected id" CssClass="ddl" runat="server" Font-Names="Calibri" Width="220px">
